...
Make sure to add each section. It really goes a long way to document your project. Imagine if I didn't document any of this!!
...
Next, we need to add a route to your page. Otherwise, people wouldn't be able to find it! The route is basically where your page will be located.
